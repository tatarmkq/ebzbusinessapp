...
// MTA - start (6)
export interface CoreCourseOptionsHandler2 extends CoreDelegateHandler {
    /**
     * The highest priority is displayed first.
     * @type {number}
     */
 ...
 * Data needed to render a course handler. It's returned by the handler.
 */
export interface CoreCourseOptionsHandlerData2 {
    /**
...
export class CoreCourseOptionsDelegate extends CoreDelegate {
     ...
     */
	 // MTA - marker : course tab options are calculated within this function
