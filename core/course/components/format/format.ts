...
export class CoreCourseFormatComponent implements OnInit, OnChanges, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        //this.displaySectionSelector = false;
    ...
    protected setInputData(): void {
        ...
        //this.data.initialSectionId = CoreCourseProvider.ALL_SECTIONS_ID;
		// alert("CHECK = " + this.initialSectionNumber);
        this.data.initialSectionNumber = this.initialSectionNumber;
        //this.data.initialSectionNumber = -1;
     ...
     */
	 /* IT.Serv - Start: ORIGINAL code (removed) */
    ...
    ionViewDidEnter(): void {
		...
		if (this.loaded == true && (this.course.id == 312 || this.course.id == 1466 || this.course.id == 1465 || this.course.id == 1467 || this.course.id == 1472 || this.course.id == 92 || this.course.id == 93 || this.course.id == 94 || this.course.id == 98 || this.course.id == 1181 || this.course.id == 302 || this.course.id == 85 || this.course.id == 77 || this.course.id == 76 || this.course.id == 64))
			this.showSectionSelector();
