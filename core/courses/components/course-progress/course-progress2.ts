 ...
 */
@Component({
	//MTA - marker : DISABLE COURSE DOWNLOAD BUTTONS (2ff)
    selector: 'core-courses-course-progress2',
    templateUrl: 'core-courses-course-progress2.html'
})
//MTA - marker : DISABLE COURSE DOWNLOAD BUTTONS (ff)
export class CoreCoursesCourseProgressComponent2 implements OnInit, OnDestroy {
