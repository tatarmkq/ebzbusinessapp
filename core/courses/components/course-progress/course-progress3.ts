 ...
 */
@Component({
    selector: 'core-courses-course-progress3',
    templateUrl: 'core-courses-course-progress3.html'
})
export class CoreCoursesCourseProgressComponent3 implements OnInit, OnDestroy {
