 ...
 */
@Component({
    selector: 'core-courses-course-progress4',
    templateUrl: 'core-courses-course-progress4.html'
})
export class CoreCoursesCourseProgressComponent4 implements OnInit, OnDestroy {
