 ...
 */
@Component({
    selector: 'core-courses-course-progress5',
    templateUrl: 'core-courses-course-progress5.html'
})
export class CoreCoursesCourseProgressComponent5 implements OnInit, OnDestroy {
