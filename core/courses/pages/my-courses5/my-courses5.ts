 ...
 */
@IonicPage({ segment: 'core-courses-my-courses5' })
@Component({
    selector: 'page-core-courses-my-courses5',
    templateUrl: 'my-courses5.html',
})
export class CoreCoursesMyCoursesPage5 implements OnDestroy {
    ...
    protected fetchCourses(): Promise<any> {
		// MTA - marker
        return this.coursesProvider.getUserCoursesSortedOrg().then((courses) => {
			// MTA - test :
