 ...
 */
@IonicPage({ segment: 'core-courses-my-courses3' })
@Component({
    selector: 'page-core-courses-my-courses3',
    templateUrl: 'my-courses3.html',
})
export class CoreCoursesMyCoursesPage3 implements OnDestroy {
    ...
    protected fetchCourses(): Promise<any> {
		// MTA - marker
        return this.coursesProvider.getEbzExamTerms().then((courses) => {
			// MTA - test :
