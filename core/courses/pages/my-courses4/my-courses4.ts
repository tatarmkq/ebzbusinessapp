 ...
 */
@IonicPage({ segment: 'core-courses-my-courses4' })
@Component({
    selector: 'page-core-courses-my-courses4',
    templateUrl: 'my-courses4.html',
})
export class CoreCoursesMyCoursesPage4 implements OnDestroy {
