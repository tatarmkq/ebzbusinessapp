 ...
 */
@IonicPage({ segment: 'core-courses-my-courses2' })
@Component({
    selector: 'page-core-courses-my-courses2',
    templateUrl: 'my-courses2.html',
})
export class CoreCoursesMyCoursesPage2 implements OnDestroy {
    ...
    protected fetchCourses(): Promise<any> {
		// MTA - marker
        return this.coursesProvider.getEbzHomsiteCourses().then((courses) => {
			// MTA - test :
