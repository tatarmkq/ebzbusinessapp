...
export class CoreCoursesProvider {
    ...
    getUserCourses(preferCache?: boolean, siteId?: string): Promise<any[]> {
        return this.sitesProvider.getSite(siteId).then((site) => {
            ...
            //return site.read('core_enrol_get_users_courses', '', preSets);
            //return '';
        });
    }
...
/*	
    /**
     * Get homepage "pseudo"-courses. (Special function programmed for EBZ
     *
     * @param {boolean} [preferCache] True if shouldn't call WS if data is cached, false otherwise.
     * @param {string} [siteId] Site to get the courses from. If not defined, use current site.
     * @return {Promise<any[]>} Promise resolved with the courses.
    ...
    getEbzHomsiteCourses(preferCache?: boolean, siteId?: string): Promise<any[]> {
        return this.sitesProvider.getSite(siteId).then((site) => {
			...
			// MTA - Hint //
            return site.read('core_get_ebz_homsite_courses', data, preSets);
            //return site.read('core_enrol_get_users_courses', '', preSets);
            //return '';
        });
    }
...
/*	
    ...
    getUserCoursesSortedFnd(preferCache?: boolean, siteId?: string): Promise<any[]> {
        return this.sitesProvider.getSite(siteId).then((site) => {
			...
			// MTA - Hint //
            return site.read('core_enrol_get_users_courses_fnd', data, preSets);
            //return site.read('core_enrol_get_users_courses', '', preSets);
            //return '';
        });
    }
...
/*	
    ...
    getUserCoursesSortedFna(preferCache?: boolean, siteId?: string): Promise<any[]> {
        return this.sitesProvider.getSite(siteId).then((site) => {
			...
			// MTA - Hint //
            return site.read('core_enrol_get_users_courses_fna', data, preSets);
            //return site.read('core_enrol_get_users_courses', '', preSets);
            //return '';
        });
    }
	
    getUserCoursesSortedOrg(preferCache?: boolean, siteId?: string): Promise<any[]> {
        return this.sitesProvider.getSite(siteId).then((site) => {
			...
			// MTA - Hint //
            return site.read('core_enrol_get_users_courses_org', data, preSets);
            //return site.read('core_enrol_get_users_courses', '', preSets);
            //return '';
        });
    }	
...
/*	
    ...
    getUserCoursesSortedSda(preferCache?: boolean, siteId?: string): Promise<any[]> {
        return this.sitesProvider.getSite(siteId).then((site) => {
			...
			// MTA - Hint //
            return site.read('core_enrol_get_users_courses_sda', data, preSets);
            //return site.read('core_enrol_get_users_courses', '', preSets);
            //return '';
        });
    }
...
/*	
    ...
    getUserCoursesSortedSdd(preferCache?: boolean, siteId?: string): Promise<any[]> {
        return this.sitesProvider.getSite(siteId).then((site) => {
			...
			// MTA - Hint //
            return site.read('core_enrol_get_users_courses_sdd', data, preSets);
            //return site.read('core_enrol_get_users_courses', '', preSets);
            //return '';
        });
    }
...
/*	
    ...
    getEbzExamTerms(preferCache?: boolean, siteId?: string): Promise<any[]> {
        return this.sitesProvider.getSite(siteId).then((site) => {
			...
			// MTA - Hint //
            return site.read('core_get_ebz_exam_terms', data, preSets);
            //return site.read('core_enrol_get_users_courses', '', preSets);
            //return '';
        });
    }
