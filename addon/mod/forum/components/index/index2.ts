...
// MTA - FORUM 
@Component({
    selector: 'addon-mod-forum-index2',
    templateUrl: 'addon-mod-forum-index2.html',
})
// MTA - FORUM
export class AddonModForumIndexComponent2 extends CoreCourseModuleMainActivityComponent {
    ...
    protected fetchContent(refresh: boolean = false, sync: boolean = false, showErrors: boolean = false): Promise<any> {
			// MTA - marker (11)
			/*
			console.log("FORUM-CHECKPOINT 1");
			console.log("RICHTIGE-KURS-ID = " + this.courseId);			
			console.log("RICHTIGE-MODUL-ID = " + this.module.id);	
			console.log("RICHTIGES-MODUL= " + JSON.stringify(this.module));	
			*/	
        return this.forumProvider.getForum(this.courseId, this.module.id).then((forum) => {	
			...
			// MTA - marker (11)
			// console.log("FEHLERMELDUNG GEFUNDEN");
    ...
    openDiscussion(discussion: any): void {
		...
		// MTA - start (11)
		/*
		console.log("KURS-ID-STANDALONE = " + this.courseId);
		console.log("CM-ID-STANDALONE = " + this.module.id);
		console.log("FORUM-ID-STANDALONE = " + this.forum.id);
		console.log("DISCUSSION-ID-STANDALONE = " + discussion.discussion);
		console.log("TRACKPOSTS-STANDALONE = " + this.trackPosts);
		console.log("LOCKED-STANDALONE = " + discussion.locked);
		*/
		// MTA - end (11)
        const params = {
		...
		// MTA - start
        //
		// this.navCtrl.push('AddonModForumDiscussionPage', params);
        // ORIGINAL: 
		this.splitviewCtrl.push('AddonModForumDiscussionPage', params);
		//this.splitviewCtrl.pop(previous);
		//this.navCtrl.getNext();
		// MTA - end
		// this.navCtrl.pop();
		//this.forumHelper.goInSite(navCtrl, 'AddonModForumDiscussionPage');		
    }
...
/*
	function openVeranstaltungsplan(): void {
		document.getElementById("wl").click();	
	}	
*/
    /**
