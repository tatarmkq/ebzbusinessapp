...
export class AddonFilesProvider {
	// MTA - ORGA
    // ORIGINAL: protected ROOT_CACHE_KEY = 'mmaFiles:';
    protected ROOT_CACHE_KEY = 'examEnrols:';
	// MTA - end
    ...
    getFiles(params: any, siteId?: string): Promise<any[]> {
        ...
        return this.sitesProvider.getSite(siteId).then((site) => {
			...
			// MTA - start (14)
            // ORIGINAL : return site.read('core_files_get_files', params, preSets);
            // NFV : return site.read('mod_choice_get_exam_enrolments', params, preSets);
			console.log("CHOICE-params = " + JSON.stringify(params));
            return site.read('mod_choice_get_exam_enrolments', params, preSets);
			// MTA - end
        }).then((result) => {
			// MTA - start (14)
			// ORIGINAL code:
