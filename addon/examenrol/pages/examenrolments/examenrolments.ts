...
// MTA - ORGA
import { AddonFilesProvider } from '../../providers/examenrol';
...
@IonicPage({ segment: 'addon-examenrol-examenrolments' })
@Component({
	// MTA - ORGA
    //selector: 'page-addon-files-list',
	//templateUrl: 'list.html',
    selector: 'page-addon-examenrol-examenrolments',
    templateUrl: 'list.html',
})
// MTA - ORGA
// export class AddonFilesListPage implements OnDestroy {
   export class ExamEnrolmentsPage implements OnDestroy {
